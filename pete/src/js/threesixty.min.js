! function (e) {
    ...
    e.ThreeSixty = function (r, t) {
        ...
        n.$el = e(r), n.el = r, n.$el.data("ThreeSixty", n), n.init = function () {
            a = e.extend({}, e.ThreeSixty.defaultOptions, t), a.disableSpin && (a.currentFrame = 1, a.endFrame = 1), n.initProgress(), n.loadImages();
        }, n.resize = function () { }, n.initProgress = function () {
            n.$el.css({
                width: a.width + "px",
                height: a.height + "px",
                "background-image": "none !important"
            }), a.styles && n.$el.css(a.styles), n.responsive(),
                e(a.progress).selector == '.bluredImg' ? n.$el.find(a.progress).fadeIn(0) : n.$el.find(a.progress).fadeIn("slow"),
            ...
            a.loadedImages += 1, e(a.progress + " span").text(Math.floor(a.loadedImages / a.totalFrames * 100) + "%"), a.loadedImages >= a.totalFrames ? (a.disableSpin && o[0].removeClass("previous-image").addClass("current-image"),
                e(a.progress).selector == '.bluredImg' ? (function () {
                    e(this).hide(),n.showImages(),n.showNavigation(),e(a.progress).fadeOut("slow");
            ...
            if (a.navigation && !a.navigation_init) {
                var r, t, o, i;
                r = e("<div/>").attr("class", "nav_bar"), t = e("<a/>").attr({
                    href: "#",
                    class: "nav_bar_next"
            ...
            e && e.preventDefault(), a.endFrame -= 1, n.refresh();
        }, n.previous = function (e) {
            e && e.preventDefault(), a.endFrame += 1, n.refresh();
        }, n.play = function (e, r) {
            var t = e || a.playSpeed,
                o = r || a.autoplayDirection;
            a.autoplayDirection = o, a.autoplay || (a.autoplay = !0, a.play = setInterval(n.moveToNextFrame, t));
        }, n.stop = function () {
            ...
            n.$el.bind("mousedown mousemove click touchstart touchmove touchend", function (e) {
                e.preventDefault(),
                    "mousedown" === e.type && 1 === e.which ||
                        "touchstart" === e.type ?
                        (a.pointerStartPosX = n.getPointerEvent(e).pageX, a.dragging = !0,
                            a.onDragStart(a.currentFrame)) :
                        "touchmove" === e.type ? n.trackPointer(e) :
                            "touchend" === e.type && (a.dragging = !1, a.onDragStop(a.endFrame));
            }), e(document).bind("mouseup", function (r) {
                a.dragging = !1, a.onDragStop(a.endFrame), e(this).css("cursor", "none");
            }), e(window).bind("resize", function (e) {
                n.responsive();
            }), e(document).bind("mousemove", function (e) {
                a.dragging ? (e.preventDefault(),
                    !n.browser.isIE && a.showCursor &&
                    n.$el.css("cursor", "url(assets/images/hand_closed.png), auto")) :
                    !n.browser.isIE && a.showCursor &&
